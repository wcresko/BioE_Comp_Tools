...
## R INTERLUDE - model fitting of multiple linear regression example {.smaller}
...
-   Last time I mentioned that ANOVAs used the same principles as linear models that we discussed last time
...
# Testing what groups differ from one another

# Post Hoc Comparisons

```{r, echo=F}
knitr::include_graphics("images/week9_turkey.jpeg")
```
...
knitr::include_graphics("images/week9_Tukeymeme.jpeg")
```

## Let's practice - Irises
...
## Let's practice - using the categorical predictor variables in the zebrafish data set
